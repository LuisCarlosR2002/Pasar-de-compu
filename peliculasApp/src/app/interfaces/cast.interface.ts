// To parse this data:
//
//   import { Convert, Cast } from "./file";
//
//   const cast = Convert.toCast(json);
//
...
export class Convert {
    public static toCast(json: string): Cast {
        return cast(JSON.parse(json), r("Cast"));
    }

    public static castToJson(value: Cast): string {
        return JSON.stringify(uncast(value, r("Cast")), null, 2);
    }
}
...
const typeMap: any = {
    "Cast": o([
        { json: "id", js: "id", typ: 0 },
        { json: "cast", js: "cast", typ: a(r("CastElement")) },
        { json: "crew", js: "crew", typ: a(r("CastElement")) },
    ], false),
    "CastElement": o([
